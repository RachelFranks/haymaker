...
// sha3: 5cf9e7ab75788e9962fe9a20fcde2a2399c57801fa440f49c81ca893cd5a5f6
...
mod __parse__Makefile {
    ...
    ) -> Option<Result<i32,__lalrpop_util::ParseError<usize, Token<'input>, &'static str>>>
    {
        let (__pop_states, __nonterminal) = match __action {
            ...
            1 => {
                // __Makefile = Makefile => ActionFn(0);
...
pub use self::__parse__Makefile::MakefileParser;
#[cfg_attr(rustfmt, rustfmt_skip)]
mod __intern_token {
    #![allow(unused_imports)]
    #[allow(unused_extern_crates)]
